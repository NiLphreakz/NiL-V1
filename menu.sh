...
echo -e "\e[$text Premium Script By NiLphreakz V.1"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
...
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   " \e[$back_text                     \e[30m[\e[$box XRAY/TROJAN MENU\e[30m ]\e[1m                   \e[m"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
...
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   "  \e[$number (•3)\e[m \e[$below CHANGE PORT\e[m"      
echo -e   "  \e[$number (•4)\e[m \e[$below CFWARP MENU\e[m"          
echo -e   "  \e[$number (•5)\e[m \e[$below SYSTEM MENU\e[m"            
echo -e   "  \e[$number (•6)\e[m \e[$below MENU THEMES\e[m"     
echo -e   "  \e[$number (•7)\e[m \e[$below CHECK RUNNING\e[m"
...
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   "  \e[$below Premium VPS by NiLphreakz V.1"
echo -e   "  \e[$below Thank you for using script by NiLphreakz V.1"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
echo -e   ""
