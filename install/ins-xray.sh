...
wget -O port-trojan "https://raw.githubusercontent.com/NiLphreakz/NiL-V1/main/change-port/port-trojan.sh"
wget -O certv2ray "https://raw.githubusercontent.com/NiLphreakz/NiL-V1/main/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/NiLphreakz/NiL-V1/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/NiLphreakz/NiL-V1/main/menu/xraay.sh"
chmod +x port-xray
chmod +x port-trojan
chmod +x certv2ray
chmod +x trojaan
